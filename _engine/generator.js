...
要件定義書を以下のいずれかの方法で、本格制作フェーズへお進めください。

### パターンA（推奨）：弊社にメールでご相談

弊社（有限会社アートソウル）にメールで要件定義書を添付してご相談ください。
- メール：**uemura@artsoul.jp**

業種・規模・トーン軸にあわせた完全カスタマイズ版ガイドラインを本格制作します。

---

### パターンB：「/ai-guideline-build」AIエージェントスキル ご希望の場合

社内でAIエージェントを運用していて、要件定義書からガイドライン本格制作までの一気通貫スキル \`/ai-guideline-build\` をご希望の場合は、お問合せください。
- メール：**uemura@artsoul.jp**

スキル設計・導入支援・運用サポートまで個別にご相談承ります。
